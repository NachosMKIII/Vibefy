...
const Sidebar = () => {
  return (
    <div className="w-[35%] h-full p-2 flex-col gap-2 text-white hidden lg:flex">
      <div className="bg-amber-200  h-[15%] rounded flex flex-col justify-around">
      ...
      <div className="bg-amber-200 h-[85%] rounded">
        ...
        <div className="p-4 bg-amber-300 m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4">
